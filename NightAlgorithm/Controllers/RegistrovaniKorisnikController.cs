...
namespace NightAlgorithm.Controllers
{
    public class RegistrovaniKorisnikController : Controller
    {
        ...
        public RegistrovaniKorisnikController(NightAlgorithmContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,korisničkoIme,lozinka,spol")] RegistrovaniKorisnik registrovaniKorisnik)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,korisničkoIme,lozinka,spol")] RegistrovaniKorisnik registrovaniKorisnik)
        {
